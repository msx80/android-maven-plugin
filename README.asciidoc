This is a fork of the original codebase adding some features to keep it in working order. Builds are available on JitPack: https://jitpack.io/#msx80/android-maven-plugin
